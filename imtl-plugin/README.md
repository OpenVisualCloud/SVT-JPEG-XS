...
### 3. Build and install imtl-plugin
...
If you get below similar message when running the RxTxApp, it's likely a ld library path problem.
...
If you get below similar message when running the RxTxApp, you need to update hugepage size
